...
(async () => {
  ...
  await fs.writeFile("other-haemolytic-anaemias-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("other-haemolytic-anaemias-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
